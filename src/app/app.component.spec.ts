...
describe('AppComponent', () => {
    ...
    it(`should have as description 'Angular 6 User Registration and Login Example & Tutorial'`, async() => {
        ...
        const footer = compile.querySelector('#footer');
        let description = footer ? (
            footer.querySelectorAll('p').length ? 
                footer.querySelectorAll('p')[0].textContent : undefined
            ) : undefined;
    ...
    it(`should have as web-link 'JasonWatmore.com'`, async() => {
        ...
        let webLink = footer ? (
            footer.querySelectorAll('p').length ? 
                footer.querySelectorAll('p')[1].textContent : undefined
            ) : undefined;
        expect(app.webLink).toEqual(webLink);
